...
//		par.setClassSelect("1111");
    ...
    public static Map convertBase64(Map<String, Object> map) {
        ...
        String user = new String(Base64.decodeBase64(base64), Charset.forName("UTF-8"));
        String[] arr = user.split(" ");
        map.put("username", arr[0]);
        return map;
    }

    public static Map getUserByTokenId(Map<String, Object> map) {
    ...
    public static Map getUserByTokenName(Map<String, Object> map) {
        String token = String.valueOf(map.get("token"));
        User user = (User) TokenCasheManager.getUserCache(token);
        if (user == null) {
            return null;
