...
import com.ziyun.basic.enums.SexEnum;
...
public class Params {
    ...
    private Integer logonIsSuperAdmin;
    private Long logonRoleId;
    private List<String> logonClassCode;
    ...
    public Integer getLogonIsSuperAdmin() {
        return logonIsSuperAdmin;
    }

    public void setLogonIsSuperAdmin(Integer logonIsSuperAdmin) {
        this.logonIsSuperAdmin = logonIsSuperAdmin;
    }

    public Long getLogonRoleId() {
        return logonRoleId;
    }

    public void setLogonRoleId(Long logonRoleId) {
        this.logonRoleId = logonRoleId;
    }

    public List<String> getLogonClassCode() {
        return logonClassCode;
    }

    public void setLogonClassCode(List<String> logonClassCode) {
        this.logonClassCode = logonClassCode;
    }
    ...
    public int hashCode() {
        return Objects.hashCode(schoolCode, facultyCode, majorCode, Arrays.toString(classCode),
                ...
                warnRuleId, warnRule, searchYear, enrollmentYear, eduStatus, termNum);
    }
