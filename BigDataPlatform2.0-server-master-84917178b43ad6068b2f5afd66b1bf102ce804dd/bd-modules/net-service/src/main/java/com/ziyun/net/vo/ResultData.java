...
public class ResultData implements Serializable, Comparable<ResultData> {
    ...
    private BigDecimal avg1;// （除以有记录的人数的）平均金额：： 浮点数：：例如-金额
    private BigDecimal allAvg1;// （除以总人数的）平均金额：： 浮点数：：例如-金额
    // --时间
    ...
    public BigDecimal getAllAvg1() {
        return allAvg1;
    }

    public void setAllAvg1(BigDecimal allAvg1) {
        this.allAvg1 = allAvg1;
    }

    public BigDecimal getTotalDuration1() {
        return totalDuration1;
    }

    public void setTotalDuration1(BigDecimal totalDuration1) {
        this.totalDuration1 = totalDuration1;
    }

    public int getValidDays1() {
        return validDays1;
    }

    public void setValidDays1(int validDays1) {
        this.validDays1 = validDays1;
    }
